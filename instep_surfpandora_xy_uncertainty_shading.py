# -*- coding: utf-8 -*-
"""
Created on Tue Oct  7 11:44:15 2025
...
for n in range(len(locations)): 
    ...
    #Time to plot!     
    #-------------------------------------
    axs[n].scatter(merge['INSTEP HCHO'], merge['HCHO'], color=color[n], s=5)
...
savePath = os.path.join(Spath,'INSTEP vs Pandora Surface with uncertainty v2')
