# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 02:38:14 2024

Random forest SLC Pandora/Topaz O3 
...
for n in range(len(pollutants)):
    for k in range(len(locations)):
        ...
        mpath = 'C:\\Users\\okorn\\Documents\\FRAPPE (2024 Modeling)\\SLC\\Outputs_{}_rf'.format(pollutants[n])
        #load the model in
        ...
        for j in range(len(locations)):
            ...
            path = 'C:\\Users\\okorn\\Documents\\FRAPPE (2024 Modeling)\\SLC'
        ...
        savePath = os.path.join(mpath,'{}_stats_application_{}.csv'.format(locations[k],pollutants[n]))
