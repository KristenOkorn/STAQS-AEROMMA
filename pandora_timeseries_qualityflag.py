...
if IQR == 'yes':
    savePath = os.path.join(Spath,'Pandora_timeseries_qualityflag_{}_{}_IQR'.format(pollutant,measTyp))
else:
    savePath = os.path.join(Spath,'Pandora_timeseries_qualityflag_{}_{}'.format(pollutant,measTyp))
