# -*- coding: utf-8 -*-
"""
Created on Thu Oct  2 18:48:54 2025

XY Scatterplot of ozone and CH4
...
for n in range(len(locations)): 
    ...
    axs[n].scatter(pod_data['INSTEP CH4'], pod_data['INSTEP O3'], label='INSTEP', color=color[n])
    
    #add a line of best fit to each
    m, b = np.polyfit(pod_data['INSTEP CH4'], pod_data['INSTEP O3'], 1)  # slope, intercept
...
savePath = os.path.join(Spath,'INSTEP_O3_CH4')
