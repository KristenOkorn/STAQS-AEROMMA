# -*- coding: utf-8 -*-
"""
Created on Wed Jan 17 15:55:40 2024
...
for n in range(len(pollutants)):
        ...
        mpath = 'C:\\Users\\okorn\\Documents\\2023 Deployment\\Modeling Surface Concentrations\\Outputs_{}_rf_allCA_hourly'.format(pollutants[n])
        #load the model in
        modelName = 'allCA_rfmodel_{}_hourly.joblib'.format(pollutants[n])
        ...
        savePath = os.path.join(mpath,'allCA_stats_application_{}_hourly.csv'.format(pollutants[n]))
