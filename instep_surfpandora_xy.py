# -*- coding: utf-8 -*-
"""
Created on Fri Oct  3 12:34:03 2025
...
for n in range(len(locations)): 
    ...
    #-------------------------------------
    podPath = 'C:\\Users\\okorn\\Documents\\2023 Deployment\\R0 STAQS Field'
    ...
    #Time to plot!     
    #-------------------------------------
    axs[n].scatter(merge['INSTEP HCHO'], merge['Pandora Surface HCHO'], color=color[n])
...
savePath = os.path.join(Spath,'INSTEP R0 vs Pandora Surface filtered HCHO')
