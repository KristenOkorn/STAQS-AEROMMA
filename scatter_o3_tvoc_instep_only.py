# -*- coding: utf-8 -*-
"""
Created on Thu Oct  2 16:25:16 2025

XY Scatterplot of ozone and VOC (HCHO + CH4)
...
fig.text(0.5, 0.04, 'CH4 + HCHO (ppm)', ha='center', va='center', fontsize=16)
...
savePath = os.path.join(Spath,'INSTEP_O3_tVOC')
