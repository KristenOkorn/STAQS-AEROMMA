...
for n in range(len(locations)):
    ...
    if merge.size != 0:
        ...
        ax4.scatter(merge['INSTEP HCHO'], merge['Pandora Surface HCHO'],c=merge['date'], marker=shapes[n], s=25, label = '{}'.format(locations[n]))
...
savePath = os.path.join(Spath,'Pandora_INSTEP_scatter_HCHO_bydate')
