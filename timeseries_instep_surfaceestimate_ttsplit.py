...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 16 08:31:52 2024
...
for n in range(len(locations)): 
    ...
    #-------------------------------------
    #add the INSTEP data to our scatterplot
    ax4[n].scatter(merge.index, merge['INSTEP O3'],c='grey', s=25)
    #add the training data to our scatterplot
    ax4[n].scatter(merge.index, merge['y_hat_test'],c='black', s=25)
    #add the testing data in black
    ax4[n].scatter(merge.index, merge['y_hat_train'],c=colors[n], s=25)
...
fig4.text(0.03, 0.5, 'O3 (ppb)', va='center', rotation='vertical')
...
savePath = os.path.join(Spath,'INSTEP_estimate_timeseries_O3_ttsplit.png')
