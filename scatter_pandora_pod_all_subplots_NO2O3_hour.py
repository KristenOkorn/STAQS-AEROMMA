# -*- coding: utf-8 -*-
"""
Created on Wed Dec  6 18:46:41 2023
...
for n in range(len(locations)): 
    ...
    sc = ax4[n].scatter(merge['INSTEP O3'], merge['Pandora {} NO2'.format(measTyp)],c=merge['Hour'], s=25)
...
#Create the full path with the figure name
if IQR == 'yes':
    savePath = os.path.join(Spath,'Pandora_INSTEP_scatter_NO2O3_{}_IQR_hour'.format(measTyp))
else:
    savePath = os.path.join(Spath,'Pandora_INSTEP_scatter_NO2O3_{}_hour'.format(measTyp))
