...
locations = ['Whittier','Caltech','AFRC','TMF']
pods = ['YPODA7','YPODG5','YPODR9','YPODA2']
...
for n in range(len(locations)): 
    ...
    if locations[n] == 'TMF' or locations[n] == 'Whittier' or locations[n] == 'AFRC':
        ...
        for k, (day, df) in enumerate(split_dataframes.items()):
            ...
            axs[k].scatter(pod_filtered['INSTEP HCHO'], pod_filtered['INSTEP altitude'], label='INSTEP', color='magenta')
            ...
            #Add a subtitle with the location & date to each subplot
